...
export const commentCreateReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case COMMENT_CREATE_SUCCESS:
      return { loading: false, commentCreated: action.payload };
...
export const commentUpdateReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case COMMENT_UPDATE_SUCCESS:
      return { loading: false, commentUpdated: action.payload };
...
export const commentDeleteReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case COMMENT_DELETE_SUCCESS:
      return { loading: false, commentDeleted: action.payload };
